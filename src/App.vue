<template>
 <div class="app-container">
   <!--顶部导航条 1：-->
      <mt-header fixed title="随购商城"></mt-header>
    ...
    <nav class="mui-bar mui-bar-tab">
			...
			<router-link class="mui-tab-item" href="#tabbar-with-chat" to="/home/login">
				<span class="mui-icon mui-icon-contact">
                </span>
				<span class="mui-tab-label">会员</span>
			</router-link>
			<router-link class="mui-tab-item" href="#tabbar-with-contact" to="/home/shopCar">
...
.app-container h1.mint-header-title{
      font-size:20px;
  }
